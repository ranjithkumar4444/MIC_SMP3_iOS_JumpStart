...
#pragma mark - Twitter Date String
+ (NSString*)blueSkyStringFromDate:(NSDate*)date {
    ...
    if(numDaysAgo <= 0) {
        if(numHoursAgo <= 0) {
            if(numMinutesAgo <= 0) {
                if(numSecondsAgo <= 0) {
                    ...
                    dateString = [NSDateFormatter stringFromDate:date withFormat:@"%@-%@-%@ %@:%@:%@ %@", DAY_OF_MONTH_FORMAT_NUM, MONTH_FORMAT_ABR, YEAR_FORMAT_4,HOUR_FORMAT,MINUTE_FORMAT,SECOND_FORMAT, AM_PM_FORMAT];
                    
                    dateString = [NSString stringWithFormat:@"%@ %is",dateString, numSecondsAgo];
                ...
                dateString = [NSString stringWithFormat:@"%@ %im",dateString, numMinutesAgo];
            ...
            dateString = [NSString stringWithFormat:@"%@ %ih",dateString, numHoursAgo];
        ...
        if(numHoursAgo < 24) {
            if(numHoursAgo > 0) {
                ...
                NSLog(@"numHoursAgo: %ih",numHoursAgo);
                

            } else {
                dateString = [NSDateFormatter stringFromDate:date withFormat:@"%@-%@-%@ %@:%@:%@ %@", DAY_OF_MONTH_FORMAT_NUM, MONTH_FORMAT_ABR, YEAR_FORMAT_4,HOUR_FORMAT,MINUTE_FORMAT,SECOND_FORMAT, AM_PM_FORMAT, numMinutesAgo];
                
                dateString = [NSString stringWithFormat:@"%@ %im",dateString, numMinutesAgo];
                
                
                
                NSLog(@"numMinutesAgo: %im",numMinutesAgo);
