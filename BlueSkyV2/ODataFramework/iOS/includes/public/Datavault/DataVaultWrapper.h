...
typedef enum {
   ...
   kDVWrapperErrorKeychainIORead,
   kDVWrapperErrorKeychainIOWrite
...
#define PWDPOLICY_DEFVALUEWRAP_MIN_LENGTH          8
...
bool DataVault_vaultExists( const char* pszVaultId ); //obsolete
bool DataVault_vaultExists2( const char* pszVaultId, DataVaultWrapperStatus* status ); 
