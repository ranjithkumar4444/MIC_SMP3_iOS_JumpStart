...
@interface SalesOrderDataController : NSObject <RequestDelegate> {
    CredentialsData *_credentials;
}

@property (nonatomic, copy) NSMutableArray *salesOrderList;
...
@property (nonatomic, strong) ODataCollection *salesOrderItemCollection;
...
// SalesOrderController singleton instance.
